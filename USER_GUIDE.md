...
```json
{
  "mcpServers": {
    "jcodemunch": {
      ...
      "args": [
        "--from",
        "https://github.com/jgravelle/jcodemunch-mcp/releases/download/v1.108.25/jcodemunch_mcp-1.108.25-py3-none-any.whl",
        "jcodemunch-mcp"
      ],
      "env": {
        "GITHUB_TOKEN": "ghp_...",
...
The `https://github.com/.../v1.108.25/...whl` URL is the temporary
